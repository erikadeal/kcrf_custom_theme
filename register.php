				...
				<div id="inner-content" class="wrap clearfix">
					...
					<?php global $user_ID, $user_identity; get_currentuserinfo(); if (!$user_ID) { //check to see if user is logged in ?>
						...
						<div id="authentication">
							...
							<p>You will receive an email once an administrator has approved your request.</p>
							...
							<form method="post" action="<?php echo site_url('wp-login.php?action=register', 'login_post') ?>" class="wp-user-form">
								...
								<div class="login_fields">
									...
									<input type="submit" name="user-submit" value="<?php _e('Register'); ?>" class="user-submit" tabindex="103" />
